...
<table id="table-notif">
       <tr>
        ...
        <tr>
            <td><img src="assets/hot.png" id="notif-img"/></td>
            <td>There are 10 news update for today. Don't miss it!</td>
            <td>2 min</td>
        </tr>
        <tr>
            <td><img src="assets/notifnissa.png" id="notif-img"/></td>
            <td>Nissa Sabyan sent you a message</td>
            <td>1 hr</td>
        </tr>
        <tr>
            <td><img src="assets/notifrio.png" id="notif-img"/></td>
            <td>Rio Dewano sent you a message</td>
            <td>2 hr</td>
        </tr>
        <tr>
            <td><img src="assets/notifgrouptoday.png" id="notif-img"/></td>
            <td>6 messages from Discussion Group 21</td>
            <td>10 hr</td>
        </tr>
        <tr>
            <td><img src="assets/notifclass.png" id="notif-img"/></td>
        ...
        <tr>
            <td><img src="assets/notifisyana.png" id="notif-img"/></td>
            <td>Isyana Sarasvati sent you a message</td>
            <td>Yesterday</td>
        </tr>
        <tr>
            <td><img src="assets/notiftompi.png" id="notif-img"/></td>
        ...
        <tr>
            <td><img src="assets/notifgrup.png" id="notif-img"/></td>
