...
<div>
  ...
  <tr>
    <td colspan="7" id="time"><h5>All Schedule</h5></td>
  </tr>
  <tr>
    <td colspan="7" id ="time"><Link to ="/Dashboard2"><h5 className ="link">For You</h5></Link></td>
  </tr>
  <tr>
    <td colspan="7" id ="time"><img src="assets/8.00.png" id="img"/></td>
  </tr>
  <tr>
    <td colspan="7" id ="time"><img src="assets/d1fc.png" id="task1-pic"/></td>
  </tr>
  <tr>
    <td colspan="7" id ="time"><img src="assets/11.00.png" id="img"/></td>
  </tr>
  <tr>
    <td colspan="7" id ="time"><img src="assets/d1sc.png" id="task1-pic"/></td>
  </tr>
  <tr>
    <td colspan="7" id ="time"><img src="assets/13.00.png" id="img"/></td>
  </tr>
  <tr>
    <td colspan="7" id ="time"><img src="assets/d1tc.png" id="task1-pic"/></td>
  </tr>
   <tr>
