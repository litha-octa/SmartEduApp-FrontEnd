...
function CreateNewClass2(props) {
    ...
    const [classNameIsTaken, setClassNameIsTaken] = useState(false);
                ...
                <div className="create-container" >
                    <table className="form-create-new-class">
                        ...
                        <tr>
                            <td>
                                <div>
                                    Categories :<select id="category-selector" onChange={categoryIdHandler}>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    Level :  &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;  <select id="category-selector" onChange={levelIdHandler}>
                    ...
                    <textarea className="description-field" onChange={descriptionHandler}></textarea>
                    <button id="btn-create" onChange={subClassHandler}>Create</button>
...
const mapDispatchToProps = (dispatch) => {
  return {
    classAdd: (data) =>
      dispatch(createClass('http://localhost:8300/api/v1/newclass/', data)),
  };
};
